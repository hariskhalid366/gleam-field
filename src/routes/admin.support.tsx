...
export const Route = createFileRoute("/admin/support")({
  head: () => ({ meta: [{ title: "Support Tickets — ServicePro Admin" }, { name: "robots", content: "noindex" }] }),
...
function SupportPage() {
  ...
  const { data: tickets = [], isLoading, isError } = useQuery({ queryKey: ["support-tickets"], queryFn: api.support.listTickets });
  ...
  return <>
    <PageHeader title="Support Tickets" description="Live customer and visitor contacts. Repeat contacts are automatically urgent." crumbs={[{ label: "Support" }]} />
