...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ServicePro — Field Service, Delivered by Verified Pros" },
      { name: "description", content: "Book verified electricians, plumbers, HVAC technicians and more. Real-time tracking, transparent pricing, and 24/7 emergency dispatch." },
      { property: "og:title", content: "ServicePro — Field Service, Delivered by Verified Pros" },
      { property: "og:description", content: "Book verified electricians, plumbers, HVAC technicians and more. Real-time tracking, transparent pricing, and 24/7 emergency dispatch." },
